...
const TURSO_DATABASE_URL = "libsql://photoclean-mobasergio.aws-eu-west-1.turso.io";
const TURSO_AUTH_TOKEN = "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NjM2NTI5ODcsImlkIjoiMzMxYjEwYzEtN2ZhMS00NDBjLTgxMzktMDZhNzVkYzI1MWExIiwicmlkIjoiZWI2N2VlZjYtNTRhYS00NmE4LWFlYTMtYWUzNDIyNzA5OTMyIn0.5UkC0ciM_RD1ZzJbnLIrhg8RGkpWZ1CwDFbQTKy5tsb5V9PC65ae-QYamEWgnz7bq6Uq8UrizLaKc7ARtlXOAA";
...
async function ensureInitialized() {
  ...
  try {
    ...
    throw new Error(
      `Database initialization failed. Please check your Turso credentials and database connection. Error: ${error instanceof Error ? error.message : String(error)}`
    );
  }
}
...
export { getFilteredResults as a, updateImageUrl as b, getStats as c, deleteSwipeResult as d, getAllResults as e, undoLastSwipe as f, getNextImage as g, hasSwipesToUndo as h, saveSwipeResult as s, updateSwipeResult as u };
